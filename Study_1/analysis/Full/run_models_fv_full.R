...
# Estimate ----------------------------------------------------------------
path0 <- "../results/full/m0_fit_fv.rds"
path1 <- "../results/full/m1_fit_fv.rds"
path2 <- "../results/full/m2_fit_fv.rds"
...
# Main Results ------------------------------------------------------------
  ...
  write_rds(m2_fv_results, "../results/full/m2_fv_effects.rds")
  
  # Model comparison ----------------------------------------------------------
  
  # Load results
  m0 <- read_rds("../results/full/m0_fit_fv.rds")
  m1 <- read_rds("../results/full/m1_fit_fv.rds")
  m2 <- read_rds("../results/full/m2_fit_fv.rds")
  ...
  results <- crossing(
    ...
    mutate(
      fit0 = map(model0, ~read_rds(paste0("../results/full/", str_to_lower(.), "_fit_fv.rds"))),
      fit1 = map(model1, ~read_rds(paste0("../results/full/", str_to_lower(.), "_fit_fv.rds")))
    )
  ...
  # Save results as .rds
  write_rds(results_comparison, "../results/full/comparison_fv.rds")
